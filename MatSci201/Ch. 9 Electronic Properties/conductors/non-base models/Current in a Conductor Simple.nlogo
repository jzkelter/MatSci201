...
to setup
  clear-all
  resize-world 0 wire-length 0 wire-cross-section-area
  ...
  ;; create electrons
  ask n-of (electron-density * count patches) patches [
    sprout-electrons 1 [
      set Vy 1 - random-float 1
      set Vx 1 - random-float 1
      set color orange - 2
      set size .2
      set charge -1
    ]
...
to go
  ...
  reset-charge-flow-if-voltage-change
...
to reset-charge-flow-if-voltage-change
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="false">
    ...
    <enumeratedValueSet variable="wire-cross-section-area">
      <value value="4"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="electron-density">
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="voltage">
      <value value="3"/>
    </enumeratedValueSet>
    <steppedValueSet variable="wire-length" first="10" step="1" last="20"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
