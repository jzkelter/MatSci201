...
# ╔═╡ f549f368-f907-11ee-035a-79078c3a7858
begin		
	using CairoMakie	
...
# ╔═╡ 6cdd937c-40ac-447c-9d8f-70a0888f35e9
function plot_continuous_approx(n_bars)
	σ = 5
	xs = range(-15, 15, length=n_bars)
	p = Plots.bar(xs, pdf(Normal(0, σ), xs), 
		linecolor=:lightblue,
		color=:lightblue,
		# label="data"
		legend=false,
		...
		left_margin=5mm,
		bottom_margin=5mm,
		title="$n_bars columns")
	
	Plots.plot!(Normal(0, σ),
		linewidth=2,
		# label="continuous approx."
	)
	return p
end

# ╔═╡ a1dc3f8d-35ca-4ead-a62f-fbb1fac8241f
begin 
	p1 = plot_continuous_approx(11)
	p2 = plot_continuous_approx(21)
	p3 = plot_continuous_approx(101)
	Plots.plot(p1, p2, p3, layout=(1, 3), size=(700, 200))
	# Plots.plot(p1, p3, layout=(1, 2), size=(700, 200))
end

# ╔═╡ e84d9491-0981-47f7-8bd1-63cecb982b45
plot_continuous_approx(59)
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "6809146210b448b7df6acfdc3fb4ae70829c5d97"
