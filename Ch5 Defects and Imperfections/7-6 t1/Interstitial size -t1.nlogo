__includes [ "molecular-dynamics-core.nls" "ch5.nls" ]
...
to simulate
  ...
  ask atoms with [not pinned?] [move-5]
...
to move-5  ; atom procedure, uses velocity-verlet algorithm
  ...
  if mouse-down? [
    ...
    if any? close-atoms [
      ask min-one-of close-atoms [distance-to-mouse] [
        ...
        ifelse calc-PE-5 > 2 [ ; if energy would be too high, don't let the atom go there.
          setxy oldx oldy
        ] [
          set vx 0
          set vy 0
