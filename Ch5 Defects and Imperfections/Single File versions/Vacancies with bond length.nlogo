...
to setup
  ...
  vab.setup-links
  set mean-bond-length mean [link-length] of links
...
to simulate
  ...
  set mean-bond-length 0.9 * mean-bond-length + 0.1 * mean [link-length] of links
...
"current KE" 1.0 0 -7500403 true "" "plot current-KE"
...
"current PE" 1.0 0 -7500403 true "" "plot PE-per-atom"
