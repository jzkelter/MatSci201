...
to make-holes
  ...
  ask p-patches [
    set pcolor rgb (160 + 40 * p-doping) (170 + 80 * p-doping) (160 + 50 * p-doping)
  ]
  ask n-of (p-doping * count p-patches) p-patches [
...
to make-electrons
  ...
  ask n-patches [
    set pcolor rgb (160 + 40 * n-doping) (160 + 50 * n-doping) (170 + 80 * n-doping)
  ]
  ask n-of (abs n-doping * count n-patches) n-patches [
    set pcharge (- e-charge)
    sprout-electrons 1 [
      electron-init
    ]
...
to go
  ...
  reset-charge-flow-if-voltage-or-scatter-prob-or-band-gap-change
...
to reset-charge-flow-if-voltage-or-scatter-prob-or-band-gap-change
  if old-voltage != voltage
     or scatter-prob != old-scatter-prob
     or old-band-gap != band-gap [
